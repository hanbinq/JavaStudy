package com.itcast.demo04.Runnable;
/*
* 创建多线程程序得第二种方式:实现Runnable接口
* java.lang.RunnableImpl
*     RunnableImpl 接口应该由那些打算通过某一线程执行其实例的类来实现。类必须定义一个称为run的无参数方法。
...
*     4.创建Thread类对象，构建方法中传递Runnable接口的实现类对象

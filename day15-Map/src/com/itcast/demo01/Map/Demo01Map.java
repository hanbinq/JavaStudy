package com.itcast.demo01.Map;

import java.util.HashMap;
import java.util.Map;

/*
* java.util.Demo01LinkedHashMap<k,v>集合
* Map集合的特点：
*     1. Map集合是一个双列集合，一个元素包含两个值(一个key,一个value)
*     2. Map集合中的元素，key和value的数据类型可以相同，也可以不同
*     3. Map集合中的元素，key是不允许重复的，value是可以重复的
*     4. Map集合中的元素，key和value是一一对应。
* java.util.HashMap<k,v>集合 implements Demo01LinkedHashMap<k,v>接口
* HashMap集合的特点：
...
//        int v2 = map.remove("林志颖");  // 自动拆箱  NullPointerException
    ...
    *         存储键值对的时候，key重复，会使用新的value奇幻map中重复的value，返回被替换的value值
    * */
